...
export function fixture(){
 ...
 for(const [key,make]of Object.entries({cube:makeCube,cylinder:()=>makeCylinder(16),sphere:makeSphere,bevel:()=>roundedBox(.1,4),bevelWorld:()=>roundedBox(.08,3),bevelActor:()=>roundedBox(.1,2),tube,leaf:leafCard,rock:rockMesh})){
