import {animateWeaponParts} from './weapon-models.js?v=12';
import {identityFor} from './combat-identity.js?v=12';
import {identity,lookAt,multiply,compose,direction,clamp,lerp,distance} from './math.js?v=12';
import {weaponModel,actorModel,part,material,makeCube,makeCylinder,makeSphere} from './geometry.js?v=12';
