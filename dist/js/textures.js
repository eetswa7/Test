export const TEXTURE_FILES=['surfaces-atlas.webp','foliage-atlas.webp','horizon.webp','weapon-finishes.webp'];
export async function loadImages(){
 ...
 return {surfaces:images[0],leaves:images[1],horizon:images[2],weapon:images[3]};
}
