import {clamp,lerp} from './math.js?v=7';
...
export const WEAPONS=specs.map((s,id)=>{const[name,kind,damage,rpm,magazine,reload,recoil,spread,range,ads,pellets,automatic,unlock]=s;return{id,name,kind,damage,rpm,magazine,reload,recoil,spread,range,ads,pellets,automatic,unlock,interval:60/rpm};});
...
export class Weapon {
 ...
 reset(){this.ammo=this.capacity;this.reserve=this.capacity*5;this.reloadLeft=0;this.cooldown=0;this.shotIndex=0;this.sinceShot=10;}
}
