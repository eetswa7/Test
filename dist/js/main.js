...
class Application {
 ...
 frame(now){requestAnimationFrame(this.frame);if(document.hidden||this.renderer.lost)return;const dt=this.last?Math.min(.08,(now-this.last)/1000):1/60;this.last=now;if(this.starting)return;
