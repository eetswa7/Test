...
async function boot(){try{await activateRelease();document.getElementById('game-version').textContent=`BREACHLINE · VERSION ${RELEASE}`;await import('./main.js?v=24');}catch(error){
