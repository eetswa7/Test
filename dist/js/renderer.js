...
export class Renderer {
 ...
 render(game,dt,menu=false,elapsed=dt){
  ...
  this.frameAverage=lerp(this.frameAverage,Math.min(elapsed*1000,200),.02);
  if(!menu&&!game.paused){this.slowTime=this.frameAverage>21?this.slowTime+elapsed:Math.max(0,this.slowTime-dt);this.fastTime=this.frameAverage<17.4?this.fastTime+elapsed:0;
