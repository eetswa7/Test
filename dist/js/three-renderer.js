import {hardWeaponBevel,patchWeaponBevel} from './weapon-surface.js?v=40';
import {installMetricUV,patchMetricUV} from './surface-uv.js?v=40';
import {SceneLOD,detailThickness,actorDetailLevel} from './scene-lod.js?v=40';
import {positionSun,shadowDue,shadowBias} from './shadow-system.js?v=40';
import {billboardVertex,billboardFragment,ambientDust,weatherParticles} from './particles.js?v=40';
import {configurePresentation,presentationCapabilities} from './render-pipeline.js?v=40';
import {DecalSystem} from './decal-system.js?v=40';
import {EnvironmentProbes,orientWeaponEnvironment,roomProbeSelected,cloudMask} from './environment-probes.js?v=40';
import {LightingField} from './lighting-field.js?v=40';
import {RoomLights} from './room-lights.js?v=40';
import {waterMaterial,patchWater} from './water-material.js?v=40';
import {visualGroundHeight} from './surface-placement.js?v=40';
import {detailMaps,patchSurfaceDetail} from './material-detail.js?v=40';
import {QUALITY,GraphicsQuality} from './graphics-quality.js?v=40';
import {GraphicsProfiler,textureBytes} from './graphics-profiler.js?v=40';
import {framebufferSize,sceneryOcclusion} from './render-budget.js?v=40';
import * as THREE from '../vendor/three.module.min.js';
import { clamp, lerp, compose, direction, distance } from './math.js?v=40';
import { makeCube, makeCylinder, makeSphere, actorModel, material, part } from './geometry.js?v=40';
import { roundedBox, tube, leafCard, rockMesh, groundSurface, ridgeMesh, ridgeTint, coniferMesh, coniferTint, strataRockMesh, strataTint } from './meshes.js?v=40';
import { loadImages } from './textures.js?v=40';
import { aimFov, verticalFov, scopeVisible, weaponPose, cameraBob } from './aim.js?v=40';
import { weaponModel, animateWeaponParts } from './weapon-models.js?v=40';
import { identityFor, IDENTITIES } from './combat-identity.js?v=40';
