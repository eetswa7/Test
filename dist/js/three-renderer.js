import {hardWeaponBevel,patchWeaponBevel} from './weapon-surface.js?v=32';
import {installMetricUV,patchMetricUV} from './surface-uv.js?v=32';
import {SceneLOD,detailThickness,actorDetailLevel} from './scene-lod.js?v=32';
import {positionSun,shadowDue,shadowBias} from './shadow-system.js?v=32';
import {billboardVertex,billboardFragment,ambientDust,weatherParticles} from './particles.js?v=32';
import {configurePresentation,presentationCapabilities} from './render-pipeline.js?v=32';
import {DecalSystem} from './decal-system.js?v=32';
import {EnvironmentProbes,orientWeaponEnvironment,roomProbeSelected,cloudMask} from './environment-probes.js?v=32';
import {LightingField} from './lighting-field.js?v=32';
import {RoomLights} from './room-lights.js?v=32';
import {waterMaterial,patchWater} from './water-material.js?v=32';
import {visualGroundHeight} from './surface-placement.js?v=32';
import {detailMaps,patchSurfaceDetail} from './material-detail.js?v=32';
import {QUALITY,GraphicsQuality} from './graphics-quality.js?v=32';
import {GraphicsProfiler,textureBytes} from './graphics-profiler.js?v=32';
import {framebufferSize,sceneryOcclusion} from './render-budget.js?v=32';
import * as THREE from '../vendor/three.module.min.js';
import { clamp, lerp, compose, direction, distance } from './math.js?v=32';
import { makeCube, makeCylinder, makeSphere, actorModel, material, part } from './geometry.js?v=32';
import { roundedBox, tube, leafCard, rockMesh, groundSurface } from './meshes.js?v=32';
import { loadImages } from './textures.js?v=32';
import { aimFov, verticalFov, scopeVisible, weaponPose, cameraBob } from './aim.js?v=32';
import { weaponModel, animateWeaponParts } from './weapon-models.js?v=32';
import { identityFor, IDENTITIES } from './combat-identity.js?v=32';
