import {hardWeaponBevel,patchWeaponBevel} from './weapon-surface.js?v=28';
import {installMetricUV,patchMetricUV} from './surface-uv.js?v=28';
import {SceneLOD,detailThickness,actorDetailLevel} from './scene-lod.js?v=28';
import {positionSun,shadowDue,shadowBias} from './shadow-system.js?v=28';
import {billboardVertex,billboardFragment,ambientDust} from './particles.js?v=28';
import {configurePresentation,presentationCapabilities} from './render-pipeline.js?v=28';
import {DecalSystem} from './decal-system.js?v=28';
import {EnvironmentProbes,orientWeaponEnvironment,roomProbeSelected,cloudMask} from './environment-probes.js?v=28';
import {LightingField} from './lighting-field.js?v=28';
import {RoomLights} from './room-lights.js?v=28';
import {waterMaterial,patchWater} from './water-material.js?v=28';
import {visualGroundHeight} from './surface-placement.js?v=28';
import {detailMaps,patchSurfaceDetail} from './material-detail.js?v=28';
import {QUALITY,GraphicsQuality} from './graphics-quality.js?v=28';
import {GraphicsProfiler,textureBytes} from './graphics-profiler.js?v=28';
import {framebufferSize,sceneryOcclusion} from './render-budget.js?v=28';
import * as THREE from '../vendor/three.module.min.js';
import { clamp, lerp, compose, direction, distance } from './math.js?v=28';
import { makeCube, makeCylinder, makeSphere, actorModel, material, part } from './geometry.js?v=28';
import { roundedBox, tube, leafCard, rockMesh, groundSurface } from './meshes.js?v=28';
import { loadImages } from './textures.js?v=28';
import { aimFov, verticalFov, scopeVisible, weaponPose, cameraBob } from './aim.js?v=28';
import { weaponModel, animateWeaponParts } from './weapon-models.js?v=28';
import { identityFor, IDENTITIES } from './combat-identity.js?v=28';
